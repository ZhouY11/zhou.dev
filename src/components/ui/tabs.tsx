  ...
  return (
    <TabPrimitive
      ...
      className={cn(
        ...
        'data-selected:bg-muted data-selected:text-foreground dark:data-selected:border-input dark:data-selected:bg-input/30 dark:data-selected:text-foreground',
